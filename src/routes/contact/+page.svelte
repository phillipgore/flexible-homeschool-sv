...
<div class="splash splash-support">
    <div class="container-lg p-tn-v-36">
        <div class="row txt-tn-center p-tn-v-36 p-sm-v-54">
            <!-- Top Heading -->
            <h1 class="fnt-size-tn-24 fnt-size-xs-36 fnt-size-sm-46 fnt-size-md-62 cl-white txt-tn-center txt-shadow p-tn-h-9 m-tn-0">Flexible Homeschool <span class="txt-condensed-black cl-success">Contact</span></h1>
            <h2 class="fnt-size-tn-16 fnt-size-sm-20 fnt-size-md-24 cl-white txt-tn-center txt-shadow m-tn-b-15">Let us know what we need to know.</h2>
            <!-- /Top Heading -->
        </div>
    </div>
</div>
...
<div class="container-md m-tn-b-72 m-tn-t-36 m-md-t-54">
    <div class="row m-tn-b-72 p-tn-rl-9 p-tn-b-72 p-xs-rl-18">
        <h1 class="h1-lg txt-tn-center m-tn-b-15">There are two ways to<br class="dis-xs-none"> contact us.</h1>
